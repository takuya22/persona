...
root_agent = SequentialAgent(
    ...
    description="3つのペルソナレビュアーにグループインタビューを実施し、インタビュー結果を収集するエージェント",
    sub_agents=[
